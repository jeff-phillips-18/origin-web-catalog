webpackJsonp([ 0, 1 ], [ function(e, t) {
    ...
    var r = n(0), i = function() {
        ...
        return e.prototype.makeAPIObjects = function(e) {
            var t = this.getPorts(e.imageStreamTag), n = r.head(t), i = [ this.makeImageStream(e), this.makeBuildConfig(e), this.makeDeploymentConfig(e, t) ];
    ...
    var r = n(0), i = function() {
        ...
        return e.prototype.getItems = function() {
            ...
            r.remove(t, function(t) {
                return t === e;
            }), t.unshift(e), t = r.take(t, 4), this.setRecentlyViewedItems(t);
    ...
    var r = function() {
        ...
        return e.prototype.$onInit = function() {
            ...
            }), this.$scope.$on("open-deploy-image-panel", function() {
                var t = e.ctrl.onDeployImageSelected();
                t && t();
            }), this.$scope.$on("open-from-file-panel", function() {
                var t = e.ctrl.onFromFileSelected();
                t && t();
            });
        }, e.prototype.$onDestroy = function() {
    ...
    var r = n(1), i = n(0), s = n(2), a = function() {
        function e(e, t, n, r, s, a, o, c, l, d) {
            ...
            }, this.deployImageClicked = function() {
                p.$scope.$emit("open-deploy-image-panel");
            }, this.fromFileClicked = function() {
                p.$scope.$emit("open-from-file-panel");
