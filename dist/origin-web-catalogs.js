webpackJsonp([ 0, 1 ], [ function(e, t) {
    ...
    (function(e) {
        ...
        var o = function() {
            e("body").find(".services-view-container ul li:nth-child(1) a")[0].click();
        }, l = function() {
            e("body").find(".services-view-container ul li:nth-child(2) a")[0].click(), setTimeout(function() {
        ...
        r.set(window, "OPENSHIFT_CONSTANTS.LANDING_PAGE_TOUR_STEPS", d);
    }).call(t, n(2));
}, function(e, t, n) {
    "use strict";
    function r() {
    ...
    var r = n(1), a = n(2), s = n(0), i = function() {
        ...
        return e.prototype.$onInit = function() {
            ...
            if (e.serviceClasses || e.imageStreams) {
                ...
                n = n.concat(s.map(this.ctrl.imageStreams, function(e) {
                    return t.Catalog.getImageItem(e);
                })), n = s.reject(n, function(e) {
                    return !e;
                }), this.allItems = s.indexBy(n, "resource.metadata.uid"), this.ctrl.recentlyViewedItems = this.getRecentlyViewedItems();
            }
    ...
    var r = n(1), a = n(0), s = n(2), i = function() {
        ...
        return e.prototype.$onInit = function() {
            ...
            this.updateAll(), this.debounceResize = a.debounce(this.resizeExpansion, 50, {
                maxWait: 250
